...
//    request.setAttribute("user", user);
    if (user != null) {
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyy年MM月dd日 HH:mm:ss"); // 定义日期格式
        String formattedCreateTime = user.getCreateTime().format(formatter); // 格式化时间
%>
